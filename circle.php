    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
            ...
            <div class="container">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="rad" placeholder="Enter radius" name="radius">
                    </div>
                    <div class="form-group">
        ...
        <?php
            ...
            if(isset($_POST['submit'])){
                ...
                $circle=new Circle($rad,$color);
                $area = $circle->getArea();
                $para = $circle->getParameter();
                $col = $circle->get_Color();
